...
\usepackage{ragged2e}
\usepackage{fancyhdr} % <--- PAQUETE AÑADIDO PARA SOLUCIONAR EL ERROR
...
\chead{}
\rhead{IMT-121 Circuitos Electrónicos I | Guía Lab A}
...
\begin{circuitikz}[scale=1, transform shape, thick]
    \draw (0,0) to[V, l={$V_1=10\,\text{V}$}, invert] (0,3) to[R, l={$R_1=4.7\,\text{k}\Omega$}] (3,3);
    \draw (6,0) to[V, l_={$V_2=5\,\text{V}$}, invert] (6,3) to[R, l_={$R_2=10\,\text{k}\Omega$}] (3,3);
    \draw (6,3) to[short, *-o] (8,3) node[above]{$a$};
    \draw (3,3) to[R, l={$R_3=6.8\,\text{k}\Omega$}] (3,0);
    \draw (0,0) -- (8,0) node[below]{$b$} to[short, -o] (8,0);
    \draw (4,0) node[ground]{};
    \draw[dashed, blue] (8,3) -- (9.5,3) to[R, l={$R_L$}] (9.5,0) -- (8,0);
\end{circuitikz}
\end{center}
