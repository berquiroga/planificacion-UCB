...
\usepackage{hyperref}
\usepackage{tikz} 
% NOTA: Se eliminó usetikzlibrary{positioning} para evitar el error de compilación.
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{Circuitos Electrónicos III (IMT-221)}[cite: 1]}
\fancyhead[R]{Proyecto Final Integrador (PFI)}
\fancyfoot[C]{\thepage}
\fancyfoot[R]{\footnotesize Semestre 2-2026[cite: 1]}
...
% ==========================================
\begin{center}
    {\Large \textbf{UNIVERSIDAD CATÓLICA BOLIVIANA ``SAN PABLO'' – SEDE TARIJA[cite: 1]}}\\[0.2cm]
    {\large Departamento de Ciencias de la Tecnología e Innovación[cite: 1]}\\[0.5cm]
...
\begin{flushleft}
    \textbf{Carrera:} Ingeniería Mecatrónica / Ingeniería Biomédica[cite: 1] \\
    \textbf{Asignatura:} Circuitos Electrónicos III (IMT-221) – Semestre 2-2026[cite: 1] \\
    \textbf{Docente:} M.Sc. Ing. Bernardo Quiroga Turdera[cite: 1]
\end{flushleft}
...
\begin{info}[Para Estudiantes de Ingeniería Mecatrónica[cite: 1]]
...
\begin{tikzpicture}[scale=0.9, transform shape]
    % Uso de tikzset (moderno) en lugar de tikzstyle
    \tikzset{
        hito/.style={rectangle, draw=blue!80!black, fill=blue!10, text width=3.5cm, text centered, rounded corners, minimum height=1.5cm, font=\small},
        flecha/.style={thick,->,>=stealth}
    }

    % Posicionamiento absoluto para eliminar dependencias y evitar el error "of"
    \node[hito] (h1) at (0,0) {\textbf{Hito 1: Sem 4[cite: 1]}\\Protección y Clamping};
    \node[hito] (h2) at (4.5,0) {\textbf{Hito 2: Sem 8[cite: 1]}\\Sensado por Shunt};
    \node[hito] (h3) at (9.0,0) {\textbf{Hito 3: Sem 13[cite: 1]}\\Puente H de Potencia};
    \node[hito] (h4) at (13.5,0) {\textbf{Hito 4: Sem 16[cite: 1]}\\Lazo Cerrado y Estabilidad};
...
\begin{description}[leftmargin=!, labelwidth=\widthof{\bfseries Hito 1 (Semana 4):}]
...
Cada entregable del proyecto se rige bajo la metodología internacional \textbf{CDIO (Concebir - Diseñar - Implementar - Operar)}[cite: 1]. Para aprobar cada hito, tu equipo debe demostrar cuatro pilares:
...
El semestre culmina en la Semana 18 con dos entregables integradores[cite: 1]:
